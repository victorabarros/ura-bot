...
process.env.BITCOINMETRX_X_CONSUMER_KEY = "test-btc-consumer-key"
process.env.BITCOINMETRX_X_CONSUMER_KEY_SECRET = "test-btc-consumer-key-secret"
process.env.BITCOINMETRX_X_ACCESS_TOKEN = "test-btc-access-token"
process.env.BITCOINMETRX_X_ACCESS_TOKEN_SECRET = "test-btc-access-token-secret"
